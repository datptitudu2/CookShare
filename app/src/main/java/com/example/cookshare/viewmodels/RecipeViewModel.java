...
public class RecipeViewModel extends AndroidViewModel {
    ...
    public void loadPopularRecipes() {
        ...
        firebaseRealtimeService.loadPopularRecipes();
    }

    public void loadFavoriteRecipes() {
        Log.d(TAG, "Loading favorite recipes");
        firebaseRealtimeService.loadFavoriteRecipes();
    }

    public void loadQuickCookRecipes() {
        Log.d(TAG, "Loading quick cook recipes");
        firebaseRealtimeService.loadQuickCookRecipes();
    }
    ...
    public void incrementViewCount(String recipeId) {
        Log.d(TAG, "Incrementing view count for recipe: " + recipeId);
        firebaseDatabaseService.incrementViewCount(recipeId);
    }

    public void updateLikeCount(String recipeId, boolean isLiked) {
        Log.d(TAG, "Updating like count for recipe: " + recipeId + ", isLiked: " + isLiked);
        firebaseDatabaseService.updateLikeCount(recipeId, isLiked);
    }
